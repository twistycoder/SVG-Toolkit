...
const Header = ({ activeTab, setActiveTab }) => {
  ...
  <div className="flex items-center space-x-3">
    ...
    <div>
      <h1 className="knewave text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
        SVG-Toolkit
      </h1>
      <p className="knewave text-xs text-gray-500 hidden sm:block">Create • Edit • Convert</p>
    </div>
  </div>
</div>
